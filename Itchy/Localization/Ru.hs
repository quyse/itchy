...
localizationRu = Localization
	...
	, locRecordDownloadNotStarted = "Загрузка не начиналась"
	, locRecordDownloadSkipped = "Загрузка пропущена"
	, locRecordDownloadFailed = "Ошибка загрузки"
	, locMessageDownloadFailed = \e -> RichText ["Ошибка загрузки: ", RichChunkCode e]
